 ...
 */
void fearCreateStore(struct FearFunctionDef *f,
                     FearBlockId parent,
                     FearValueId ptr,
                     FearValueId value);
 ...
 */
void fearFunctionSetCC(struct FearModule *m, FearFuncId id, enum FearCallConv cc);
 ...
 */
void fearDefineFunction(struct FearModule *m,
                        FearFuncId id,
