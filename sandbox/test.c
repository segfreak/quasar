...
void
test_diamond (FearModule *m)
{
  FearType   params[] = { FearInt32, FearInt32, FearInt32 };
  FearFuncId fid = fearDeclareFunction (m, "diamond", params, 3, FearInt32,
                                        FearLinkageExternal);
...
void
test_if_else_chain (FearModule *m)
{
  FearType   params[] = { FearInt32, FearInt32, FearInt32 };
...
void
test_early_return (FearModule *m)
{
  FearType   params[] = { FearInt32, FearInt32, FearInt32 };
...
void
test_big_cfg_stress (FearModule *m)
{
  FearType   params[] = { FearInt32, FearInt32, FearInt32 };
  ...
  FearValueId tmp4 = fearCreateDiv (
      f, m2, FearInt32, tmp3,
...
void
test_memory_stack_heavy (FearModule *m)
{
  FearType   params[] = { FearInt32, FearInt32, FearInt32 };
  FearFuncId fid = fearDeclareFunction (m, "memory_stack_heavy", params, 3,
                                        FearInt32, FearLinkageExternal);
  ...
  FearValueId new_acc2 = fearCreateAdd (f, body, FearInt32, new_acc, base);
