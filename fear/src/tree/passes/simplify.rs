    ...
    match expr {
        ...
        Expr::Mul(a, b) => {
            ...
            match (&a, &b) {
                ...
                (Expr::Div(_, box x, box Expr::Const(y)), Expr::Const(z)) if *y == *z => {
                    *changed = true;
                    x.clone()
                }
        ...
        Expr::Div(signed, a, b) => {
            ...
            match (&a, &b) {
                ...
                (Expr::Mul(box x, box Expr::Const(y)), Expr::Const(z)) if z % y == 0 => {
                    *changed = true;
                    Expr::Div(signed, Box::new(x.clone()), Box::new(Expr::Const(z / y)))
                }
