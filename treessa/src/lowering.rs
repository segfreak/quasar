...
pub struct FearLowerer {
    pub vmap: HashMap<ValueId, fear::ir::ValueId>,
    pub bmap: HashMap<BlockId, fear::ir::BlockId>,
}
...
impl FearLowerer {
    ...
    pub fn lower_function(&mut self, src: &FunctionDef, dst: &mut fear::ir::FunctionDef) {
    ...
    fn lower_block(&mut self, b: BlockId, src: &FunctionDef, dst: &mut fear::ir::FunctionDef) {
